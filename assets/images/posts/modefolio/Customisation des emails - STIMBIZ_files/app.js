...
+function($, window){
  ...
  app.defaults = {
    ...
    modaler: {
      ...
      cancelVisible: false,
      cancelText: 'Cancel',
      cancelClass: 'btn btn-w-sm btn-flat btn-round btn-secondary',
      bodyExtraClass: '',
...
+function($){
  ...
  provider.initSweetalert2 = function() {
    ...
    sweetAlert.setDefaults({
      confirmButtonClass: 'btn btn-bold btn-third',
  ...
  provider.initSwiper = function() {
    ...
    //new swiper RS
    provider.provide('rsswiper', function(){
      var options = {
        autoplay: 0,
        speed: 1000,
        loop: true,
        ...
        onSlideChangeEnd: function (e) {
          ...
          var countSlide = e.slides.length;

          console.log(currentSlide, countSlide);

          //element check
          var checkButton = e.container.find('.swiper-button-valid');

          if(currentSlide >= countSlide-1){
            checkButton.removeClass("swiper-button-disabled");
          }
          else{
            checkButton.addClass("swiper-button-disabled");
          }
        },
        onInit: function(e){
          var currentSlide = e.activeIndex;
...
+function($, window){
  ...
  topbar.init = function() {
    ...
    // Topbar cat scrollable
    //
    $('.topbar #store-cart-container .media-list').perfectScrollbar();
  ...
  app.initThePlugins = function() {
    ...
    */
    ...
    $(document).on('click', '[data-dismiss="tab"]', function(){
      $(this).cosest('.nav-item').fadeOut(function(){
        $(this).remove();
      });
    });
